            ...
            <div className='px-2 flex justify-between items-center w-full h-full'>
                <div >
                    ...
                    <ul className={!nav ? 'hidden' : 'absolute top-16 left-0 bg-black text-white w-full sm:hidden'}>
                        <li className='border-b-2 border-zinc-300 cursor-default hover:bg-indigo-600 h-10 text-center p-2'><Link to="#" onClick={handleClick}>Home</Link></li>
                        <li className='border-b-2 border-zinc-300  cursor-default hover:bg-indigo-600 h-10 text-center p-2'><Link to="/products" onClick={handleClick} >Products</Link></li>
                        <li className='border-b-2 border-zinc-300  cursor-default hover:bg-indigo-600 h-10 text-center p-2'><Link to="/aboutus" onClick={handleClick}>About Us</Link></li>
                        <li className='border-b-2 border-zinc-300  cursor-default hover:bg-indigo-600 h-10 text-center p-2'>  <Link to="/signup" onClick={handleClick}>Sign Up</Link></li>
                    </ul>
                </div>
